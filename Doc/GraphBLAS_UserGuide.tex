...
where $N$ can be \verb'INT32' or \verb'INT64':
...
I have 78 JIT kernels but could write about another 10 to 23 for
\verb'GrB_extract', \verb'GrB_kronecker', and other kernels.  Grep the source
code for \verb'JIT: needed' or \verb'JIT: possible' for a list.
...
\item Nov XX, 2024: version 9.4.1 (BETA)    % FIXME

    \begin{itemize}
    \item More JIT kernels: all JIT kernels for \verb'GrB_assign' and
    \verb'GxB_subassign' have been created.
    \end{itemize}

\item Oct 15, 2024: version 9.4.0 (BETA)    % FIXME
