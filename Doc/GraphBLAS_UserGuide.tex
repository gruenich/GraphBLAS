...
\item XX, 2025: version 10.0.0
    ...
    \item 32/64 bit matrices and vectors: the \verb'GrB_Matrix' and
        ...
        \verb'GrB_extract', \verb'GrB_assign', and \verb'GxB_subassign'.  The
        API is upward-compatible with 9.4.3, but only after recompilation,
        since the non-opaque \verb'GxB_Iterator' object must change.  As a
        result, the SO version must increase to 10.0.0.
    \end{itemize}
