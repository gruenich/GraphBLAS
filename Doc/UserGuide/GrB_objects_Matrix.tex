...
% NEW:
\verb'GxB_Matrix_build_Vector'         & build a matrix from tuples     & \ref{matrix_build_Vector} \\ %% NEW
\verb'GxB_Matrix_build_Scalar_Vector'  & build a matrix from tuples     & \ref{matrix_build_Scalar_Vector} \\  %% NEW
...
% NEW:
\verb'GxB_Matrix_extractTuples_Vector' & get all entries from a matrix  & \ref{matrix_extractTuples_Vector} \\ %% NEW
...
%-------------------------------------------------------------------------------
\subsubsection{{\sf GxB\_Matrix\_build\_Vector:} build a matrix from a set of tuples}   %% NEW
%-------------------------------------------------------------------------------
...
input vectors; the default is to use the values.  See Section~\ref{fixme} for
details.  %% FIXME
...
% \newpage
%-------------------------------------------------------------------------------
\subsubsection{{\sf GxB\_Matrix\_build\_Scalar\_Vector:} build a matrix from a set of tuples}   %% NEW
%-------------------------------------------------------------------------------
...
See Section~\ref{fixme} for details.  %% FIXME
...
%-------------------------------------------------------------------------------
\subsubsection{{\sf GxB\_Matrix\_extractTuples\_Vector:} get all entries from a matrix} %% NEW
%-------------------------------------------------------------------------------
