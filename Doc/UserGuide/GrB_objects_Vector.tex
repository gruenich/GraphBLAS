...
% NEW for v10:
\verb'GxB_Vector_build_Vector'          & build a vector from tuples       & \ref{vector_build_Vector} \\   %% NEW
\verb'GxB_Vector_build_Scalar_Vector'   & build a vector from tuples       & \ref{vector_build_Scalar_Vector} \\  %% NEW
...
% NEW for v10:
\verb'GxB_Vector_extractTuples_Vector'  & get all entries from a vector    & \ref{vector_extractTuples_Vector} \\ %% NEW
...
\newpage
%-------------------------------------------------------------------------------
\subsubsection{{\sf GrB\_Vector\_build\_Vector:} build a vector from a set of tuples}   %% NEW
%-------------------------------------------------------------------------------
...
Section~\ref{fixme} for details.  %% FIXME
...
%-------------------------------------------------------------------------------
\subsubsection{{\sf GxB\_Vector\_build\_Scalar\_Vector:} build a vector from a set of tuples} %% NEW
%-------------------------------------------------------------------------------
...
is to use the values.  See Section~\ref{fixme} for details.  %% FIXME
...
%-------------------------------------------------------------------------------
\subsubsection{{\sf GxB\_Vector\_extractTuples\_Vector:} get all entries from a vector} %% NEW
%-------------------------------------------------------------------------------
