...
// FIXME: place the code in slice/include/GB_search_for_vector_template.c.

#ifndef GB_SEARCH_FOR_VECTOR_H
#define GB_SEARCH_FOR_VECTOR_H

//------------------------------------------------------------------------------
// GB_search_for_vector_64
//------------------------------------------------------------------------------

static inline int64_t GB_search_for_vector_64 // return vector k that contains p
(
...
//------------------------------------------------------------------------------
// GB_search_for_vector_32
//------------------------------------------------------------------------------

static inline int64_t GB_search_for_vector_32 // return vector k that contains p
(
    const int64_t p,                // search for vector k that contains p
    const uint32_t *restrict Ap,    // vector pointers to search
    int64_t kleft,                  // left-most k to search
    int64_t anvec,                  // Ap is of size anvec+1
    int64_t avlen                   // A->vlen
)
