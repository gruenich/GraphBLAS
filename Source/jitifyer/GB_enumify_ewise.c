...
)
{
    ...
    // total method_code bits: 55 (14 hex digits); 9 bits to spare.

    (*method_code) =
                                               // range        bits
                // C, M, A, B: 32/64 (8 bits) (2 hex digits)
                GB_LSHIFT (cp_is_32   , 55) |  // 0 or 1       1
                GB_LSHIFT (ci_is_32   , 54) |  // 0 or 1       1
                GB_LSHIFT (mp_is_32   , 53) |  // 0 or 1       1
                GB_LSHIFT (mi_is_32   , 52) |  // 0 or 1       1
                GB_LSHIFT (ap_is_32   , 51) |  // 0 or 1       1
                GB_LSHIFT (ai_is_32   , 50) |  // 0 or 1       1
                GB_LSHIFT (bp_is_32   , 49) |  // 0 or 1       1
