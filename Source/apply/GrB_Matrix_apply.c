...
{                                                                           \
    GB_WHERE (C, M, A, NULL, NULL, NULL,                                    \
        GB_STR(prefix) "_Matrix_apply_BinaryOp2nd_" GB_STR(T)               \
...
{                                                                           \
    GB_WHERE (C, M, A, NULL, NULL, NULL,                                    \
        GB_STR(prefix) "_Matrix_apply_IndexOp_" GB_STR(T)                   \
...
{ 
    GB_WHERE (C, M, A, thunk, NULL, NULL,
