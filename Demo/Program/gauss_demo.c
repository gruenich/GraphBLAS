...
int main (void)
{
    ...
    if (control == GxB_JIT_ON)
    {
        ...
        if (info != GrB_SUCCESS)
        {
            ...
            OK (GrB_BinaryOp_new (&BadAddGauss, (void *) badaddgauss,
                Gauss, Gauss, Gauss)) ;
        }
    ...
    for (int trial = 0 ; trial <= 1 ; trial++)
    {
        ...
        if (info != GrB_SUCCESS)
        {
            ...
            OK (GrB_BinaryOp_new (&AddGauss, (void *) addgauss,
                Gauss, Gauss, Gauss)) ;
        }
    ...
    OK (GxB_BinaryOp_new (&MultGauss, (void *) multgauss,
...
//  OK (GxB_Matrix_Option_set (D, GxB_SPARSITY_CONTROL, GxB_SPARSE)) ;
//  OK (GxB_Matrix_Option_set (D, GxB_SPARSITY_CONTROL, GxB_BITMAP)) ;
...
//  OK (GxB_Matrix_Option_set (D, GxB_SPARSITY_CONTROL, GxB_SPARSE)) ;
    ...
    OK (GxB_UnaryOp_new (&RealGauss, (void *) realgauss, GrB_INT32, Gauss,
    ...
    OK (GxB_IndexUnaryOp_new (&IJGauss, (void *) ijgauss, GrB_INT64, Gauss,
