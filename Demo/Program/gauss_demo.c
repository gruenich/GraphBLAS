...
int main (void)
{
    ...
    // this setting.
    OK (GrB_Global_set_INT32 (GrB_GLOBAL, true, (GrB_Field) GxB_JIT_USE_CMAKE)) ;
    ...
    OK (GrB_Global_get_String (GrB_GLOBAL, str,
        (GrB_Field) GxB_JIT_C_COMPILER_NAME)) ;
    printf ("JIT C compiler:   [%s]\n", str) ;

    OK (GrB_Global_get_String (GrB_GLOBAL, str,
        (GrB_Field) GxB_JIT_C_COMPILER_FLAGS)) ;
    printf ("JIT C flags:      [%s]\n", str) ;

    OK (GrB_Global_get_String (GrB_GLOBAL, str,
        (GrB_Field) GxB_JIT_C_LINKER_FLAGS)) ;
    printf ("JIT C link flags: [%s]\n", str) ;

    OK (GrB_Global_get_String (GrB_GLOBAL, str,
        (GrB_Field) GxB_JIT_C_LIBRARIES)) ;
    printf ("JIT C libraries:  [%s]\n", str) ;

    OK (GrB_Global_get_String (GrB_GLOBAL, str,
        (GrB_Field) GxB_JIT_C_PREFACE)) ;
    printf ("JIT C preface:    [%s]\n", str) ;

    OK (GrB_Global_get_String (GrB_GLOBAL, str,
        (GrB_Field) GxB_JIT_CACHE_PATH)) ;
    printf ("JIT cache:        [%s]\n", str) ;

    int control ;
    OK (GrB_Global_get_INT32 (GrB_GLOBAL, &control,
    ...
    OK (GrB_Global_set_INT32 (GrB_GLOBAL, GxB_JIT_ON,
        (GrB_Field) GxB_JIT_C_CONTROL)) ;
    OK (GrB_Global_get_INT32 (GrB_GLOBAL, &save,
        (GrB_Field) GxB_JIT_C_CONTROL)) ;
    printf ("jit: status %d\n", save) ;
    ...
    OK (GrB_Matrix_set_INT32 (D, GxB_SPARSE,
        (GrB_Field) GxB_SPARSITY_CONTROL)) ;
    ...
    OK (GrB_Matrix_set_INT32 (D, GxB_SPARSE,
        (GrB_Field) GxB_SPARSITY_CONTROL)) ;
    OK (GrB_Matrix_set_INT32 (D, GxB_BITMAP,
        (GrB_Field) GxB_SPARSITY_CONTROL)) ;
    ...
    OK (GrB_Matrix_set_INT32 (C, GxB_FULL, (GrB_Field) GxB_SPARSITY_CONTROL)) ;
    GrB_Matrix STiles [4] ;
    ...
    // pause the JIT
    printf ("JIT: paused\n") ;
    OK (GrB_Global_set_INT32 (GrB_GLOBAL, GxB_JIT_PAUSE,
        (GrB_Field) GxB_JIT_C_CONTROL)) ;
    OK (GrB_Global_get_INT32 (GrB_GLOBAL, &control,
        (GrB_Field) GxB_JIT_C_CONTROL)) ;
    save = control ;
    ...
    OK (GrB_Global_set_INT32 (GrB_GLOBAL, GxB_JIT_RUN,
        (GrB_Field) GxB_JIT_C_CONTROL)) ;
    OK (GrB_Global_get_INT32 (GrB_GLOBAL, &control,
        (GrB_Field) GxB_JIT_C_CONTROL)) ;
    save = control ;
